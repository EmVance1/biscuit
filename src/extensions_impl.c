...
float sfVec2f_cmp(sfVector2f a, sfVector2f b)   { const float c = a.x - b.x; const float d = a.y - b.y; return c > d ? c : d; }
...
int   sfVec2i_cmp(sfVector2i a, sfVector2i b)   { const int c = a.x - b.x; const int d = a.y - b.y; return c > d ? c : d; }
...
int   sfVec2u_cmp(sfVector2u a, sfVector2u b)   { const int c = (int)a.x - (int)b.x; const int d = (int)a.y - (int)b.y; return c > d ? c : d; }
