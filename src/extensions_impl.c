...
float sfVec2f_lenSquared(sfVector2f v) { return sfVec2f_dot(v, v); }
...
int   sfVec2i_lenSquared(sfVector2i v) { return sfVec2i_dot(v, v); }
...
unsigned int sfVec2u_dot(sfVector2u a, sfVector2u b) { return a.x * b.x + a.y * b.y; }
unsigned int sfVec2u_lenSquared(sfVector2u v) { return sfVec2u_dot(v, v); }
